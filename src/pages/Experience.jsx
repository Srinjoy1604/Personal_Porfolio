                    ...
                    <div className="grid grid-cols-2 gap-4 w-[100%] h-[100%] place-items-center max-[1007px]:grid-cols-1">
                        {ExperienceList.map((exp, index) => (
                            <div key={index} className={`${styles.ExpBlock} p-[2%] w-[90%] h-[100%]`}>
                                ...
                                <div className="grid grid-flow-col max-[500px]:grid-flow-row">
                                    <div className="m-[1%] min-w-[150px] h-[100%] max-[500px]:grid max-[500px]:place-items-center"><img src={exp.Image} className="h-[100%]"></img></div>
                                    <div className="m-[1%]">
